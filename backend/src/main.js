...
var users_seed_1 = require("./users/users.seed");
var users_module_1 = require("./users/users.module");
var path_1 = require("path");
function bootstrap() {
    var _a;
    return __awaiter(this, void 0, void 0, function () {
        var app, seedService, config, document, distPath;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    config = new swagger_1.DocumentBuilder()
                        ...
                        .setVersion('1.0')
                        .addTag('projetos')
                        .addBearerAuth({ type: 'http', scheme: 'bearer', bearerFormat: 'JWT', name: 'JWT', description: 'Insira o seu token JWT aqui', in: 'header' }, 'token-jwt')
                        .build();
                    document = swagger_1.SwaggerModule.createDocument(app, config);
                    swagger_1.SwaggerModule.setup('docs', app, document);
                    distPath = (0, path_1.join)(process.cwd(), 'frontend', 'dist', 'index.html');
